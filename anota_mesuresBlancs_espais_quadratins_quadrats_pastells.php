...
}
{
 ...
 {
  echo "$prompt";
  echo "<br><center style='color:#000000;font-family:monospace;font-size:16px'>L'&iacute;ndex zero del primer array indica les unitats /p (punts), la resta d'&iacute;ndex indiquen el valor del cos.<br>Les subarrays de cadascun dels cossos actius duen tamb&eacute; a l'&iacute;ndex zero les unitats /p (punts) i la resta de valors s&oacute;n les mesures d'amplada de cada pe&ccedil;a.</center><br></pre>";
