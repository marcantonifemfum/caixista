<?php
  ...
  $PSapplet = "mesuresBlancs_imposicions_prompt.ps";
  //
  ...
  echo "<center><span style='color:#ff0000;font-family:monospace;font-size:24px'><br><br>&gt;&gt;&gt; Taula de Mesures de Blancs d'Imposicions &lt;&lt;&lt;</span></center>";
...
}
{
 ...
 if ($ElQtorna == 0)
 {
  ...
  echo "<br><center style='color:#000000;font-family:monospace;font-size:16px'>L'&iacute;ndex zero del primer array indica les unitats /c (c&iacute;ceros), la resta d'&iacute;ndex indiquen el valor del cos.<br>Les subarrays de cadascun dels cossos actius duen tamb&eacute; a l'&iacute;ndex zero les unitats /c (c&iacute;ceros) i la resta de valors s&oacute;n les mesures d'amplada de cada pe&ccedil;a.</center><br></pre>";
