<?php
  ...
  //echo "<br><br><span style='color:#999999;font-family:monospace;font-size:24px'>".$prompt." + ".$ElQtorna."<br></span></center>";
   ...
   echo "<br><center style='color:#000000;font-family:monospace;font-size:16px'>L'índex zero del primer array indica les unitats /c (cíceros), la resta d'índex indiquen el valor del cos<br>Les subarrays de cadascun dels cossos actius duen també a l'índex zero les unitats /c (cíceros) i la resta de valors són les mesures d'amplada de cada peça</center><br></pre>";
