<?php
  ...
  //$somaPDF = "re.pdf";  // al servidor ub.edu/tallerdetipografia
  ...
  $command = $somaGS . "gs -q -dNOSAFER -o '" . $somaPDF . "' -sDEVICE=pdfwrite -f 'mesuresBlancs_interlinies_prompt.ps'";
  ...
  //echo "<br><br><span style='color:#999999;font-family:monospace;font-size:24px'>".$prompt." + ".$ElQtorna."<br></span></center>";
   ...
   // mètode senzill de llistat del prompt
