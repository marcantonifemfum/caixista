<?php
  ...
  echo "<center><span style='color:#ff0000;font-family:monospace;font-size:24px'><br><br>&gt;&gt;&gt; Taula de Mesures de Blancs d'Interlínies &lt;&lt;&lt;</span></center>";
  //echo "<br><br><span style='color:#999999;font-family:monospace;font-size:24px'>".$prompt." + ".$ElQtorna."<br></span></center>";
   ...
   echo "<br><center style='color:#000000;font-family:monospace;font-size:16px'>L'índex zero del primer array indica les unitats /p (punts), la resta d'índex indiquen el valor del cos<br>Les subarrays de cadascun dels cossos duen també a l'índex zero les unitats /c (cíceros) i la resta de valors són les mesures d'amplada de cada peça</center><br></pre>";
